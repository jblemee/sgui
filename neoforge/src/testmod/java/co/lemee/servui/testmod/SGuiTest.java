package co.lemee.servui.testmod;
...
import co.lemee.servui.api.elements.*;
import co.lemee.servui.api.gui.*;
import co.lemee.servui.api.gui.layered.Layer;
import co.lemee.servui.api.gui.layered.LayerView;
import co.lemee.servui.api.gui.layered.LayeredGui;
...
public class SGuiTest {
    ...
    public static final String MOD_ID = "servuitest";
    public static final Logger LOGGER = LoggerFactory.getLogger(MOD_ID);

    public SGuiTest(IEventBus modEventBus, ModContainer modContainer) {
        LOGGER.info("NeoForge ServUI test mod loaded!");
